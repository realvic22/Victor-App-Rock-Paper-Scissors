document.addEventListener("DOMContentLoaded", () => {
  ...
  choicesEl.addEventListener("click", (e) => {
    if (e.target.classList.contains("choice") || e.target.parentElement.classList.contains("choice")) {
      const playerChoice = e.target.dataset.choice || e.target.parentElement.dataset.choice
